<>
  <ul className="my-link-list">
    ...
    {/* Github */}
    <li>
      <a href="https://github.com/arunav999" className="my-link" target="blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    {/* WhatsApp */}
    <li>
      <a href="https://wa.me/917008122921" className="my-link" target="blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    {/* Codepen */}
    <li>
      <a href="https://codepen.io/SLYTERKIT" className="my-link" target="blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="box-content">
              ...
              <div className="pro-desc">
                ...
                <div className="pro-btns">
                  <a
                    href="https://adorable-dusk-9a2e6d.netlify.app/"
                    target="blank"
                    className="pro-btn"
                  >
                    <svg
                  ...
                  <a
                    href="https://github.com/arunav999/OMNI_FOOD-Project"
                    target="blank"
                    className="pro-btn"
                  >
                    Code
